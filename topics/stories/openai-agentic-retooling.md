...
# OpenAI Agentic Development Retooling

An internal account of how OpenAI is restructuring its engineering teams around agentic software development, shared publicly in February 2026.

## Index

- [The Full Statement](#the-full-statement)
- [Key Themes](#key-themes)
- [The March 31st Goals](#the-march-31st-goals)
- [The Six Recommendations](#the-six-recommendations)
- [Sources](#sources)
...
**The Step Function**: The post claims a qualitative shift in December - engineers went from using agents for unit tests to having agents write "essentially all the code." This isn't gradual improvement but a capability discontinuity.

**Cultural Over Technical**: Repeatedly emphasizes that adoption is cultural change, not just tooling. The barriers aren't model capability but organizational readiness.

**Agent-First Workflows**: The goal is inverting the default - agents become the first resort, with humans supervising rather than implementing.

**Quality at Scale**: The "slop" warning acknowledges a real tension: agents produce functional code fast, but maintainability suffers without deliberate process.

## The March 31st Goals

Two concrete targets for OpenAI teams:

1. **Agent as first resort**: For any technical task, default to interacting with an agent before opening an editor or terminal
2. **Safe defaults with productivity**: Standard agent usage should be both safe and productive enough that most workflows don't need special permissions

## The Six Recommendations

| # | Recommendation | Key Actions |
|---|----------------|-------------|
| 1 | Try the tools | Designate "agents captain," internal channels, hackathon |
| 2 | Create skills and AGENTS.md | Maintain project-level agent instructions, share skills |
| 3 | Make internal tools accessible | CLI or MCP server for team tools |
| 4 | Structure codebases agent-first | Fast tests, clean interfaces |
| 5 | Say no to slop | Human accountability, maintain review bar |
| 6 | Build basic infra | Observability, trajectory tracking, tool management |

## Sources

1. [X/Twitter post](https://x.com/i/status/2019566641491963946)
