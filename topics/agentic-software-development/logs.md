...
Additional thread context: [2024987174077432126](https://x.com/i/status/2024987174077432126)
...
*2026-02-26T16:00:00Z* | Tags: vibe-coding, agentic-engineering, workflow-evolution, expertise-multiplier, karpathy
...
- On Omarchy (DHH's Linux setup): hopes agents will dramatically lower the barrier to working with Linux; envisions a skill library for Linux and an AI that assists with all configurations
